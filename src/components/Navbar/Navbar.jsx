    ...
    render() {
        return (
            <div className='navbarBlack'>
                ...
                <a className='navfloatright' href='/team/2022-2023'>Team</a>
                <a className='navfloatright' href='/events/2022-2023'>Upcoming Events</a>
                <a className='navfloatright' href='/past_events/2022-2023'>Past Events</a>
